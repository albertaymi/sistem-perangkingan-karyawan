...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        @if ($kriteria->isEmpty())
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-12">
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('penilaian.index') }}"
                            class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-lg hover:bg-gray-700 cursor-pointer">
        ...
        @else
            <!-- Main Form -->
            <form action="{{ route('penilaian.update', [$karyawan->id, $bulan, $tahun]) }}" method="POST"
                id="form-edit-penilaian">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="border border-gray-200 rounded-lg overflow-hidden">
                                ...
                                <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-5 py-3 border-b border-blue-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h3 class="text-base font-bold text-gray-900">{{ $kriteriaItem->nama_kriteria }}
                                            </h3>
                                        ...
                                        <div class="px-5 py-4 hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <div class="mt-3">
                                                @php
                                                    ...
                                                    $existingCatatan =
                                                        $existingPenilaian->get($subItem->id)->catatan ?? '';
                                                @endphp
                                                ...
                                                @elseif($subItem->tipe_input === 'rating')
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <span class="ml-3 text-xs text-gray-500">
                                                            ({{ $subItem->nilai_min }} - {{ $subItem->nilai_max }}
                                                            bintang)
                                                        </span>
                                                    </div>
                                                @elseif($subItem->tipe_input === 'dropdown')
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            <strong>Peringatan:</strong> Sub-kriteria ini tidak memiliki
                                                            opsi dropdown. Silakan tambahkan opsi terlebih dahulu.
                                                        </div>
                                                    @endif
                                                @endif
                                            </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <textarea name="penilaian[{{ $kriteriaIndex }}_{{ $subIndex }}][catatan]"
                                                    ...
                                                    rows="2" placeholder="Tambahkan catatan khusus (opsional)">{{ old('penilaian.' . $kriteriaIndex . '_' . $subIndex . '.catatan', $existingCatatan) }}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
                        ...
                        <button type="submit"
                            class="inline-flex items-center px-6 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-colors duration-150 cursor-pointer">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        function showToast(message, type = 'success') {
            ...
            <button type="button" class="cursor-pointer ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-white hover:bg-opacity-20 transition-colors" onclick="this.parentElement.remove()">
