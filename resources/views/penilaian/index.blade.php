...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">Kelola penilaian kinerja karyawan berdasarkan kriteria yang telah ditentukan</p>
    </div>
            ...
            <form method="GET" action="{{ route('penilaian.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="flex items-end">
                        <button type="submit"
                            class="w-full px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-150 shadow-sm">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">{{ $firstItem->karyawan->nama }}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="{{ route('penilaian.edit', [$firstItem->id_karyawan, $firstItem->bulan, $firstItem->tahun]) }}"
                                        class="inline-flex items-center px-3 py-1.5 bg-yellow-600 text-white text-xs font-medium rounded-lg hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-all duration-150">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    {{-- Button Hapus --}}
                                    <button type="button" onclick="confirmDelete({{ $firstItem->id_karyawan }}, {{ $firstItem->bulan }}, {{ $firstItem->tahun }}, '{{ $firstItem->karyawan->nama }}', '{{ $firstItem->periode_lengkap }}')"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan penilaian pertama untuk karyawan.</p>
                                <div class="mt-6">
                                    <a href="{{ route('penilaian.create') }}"
    ...
    <div id="modal-hapus-penilaian" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden">
