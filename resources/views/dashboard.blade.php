    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        @elseif(auth()->user()->isSupervisor())
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">Karyawan Dibawahi</p>
                        <p class="text-3xl font-bold text-gray-900">{{ $stats['total_karyawan_assigned'] }}</p>
                    </div>
                    <div class="bg-blue-100 p-3 rounded-lg">
                        <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">Kriteria Ditugaskan</p>
                        <p class="text-3xl font-bold text-gray-900">{{ $stats['total_kriteria'] }}</p>
                    </div>
                    <div class="bg-purple-100 p-3 rounded-lg">
                        <svg class="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">Status Ranking</p>
                        <p class="text-lg font-bold text-gray-900">
                            @if ($stats['ranking_generated'])
                                <span class="text-green-600">✓ Sudah Generate</span>
                            @else
                                <span class="text-gray-400">Belum Generate</span>
                            @endif
                        </p>
                    </div>
                    <div class="bg-green-100 p-3 rounded-lg">
