...
@section('content')
        ...
        <div class="p-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <div class="text-4xl font-bold {{ $totalBobot == 100 ? 'text-green-600' : ($totalBobot > 100 ? 'text-red-600' : 'text-yellow-600') }}">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-2 flex-wrap">
                                    ...
                                    <form action="{{ route('kriteria.toggle-status', $item->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    {{-- Button Hapus --}}
                                    <button type="button" onclick="confirmDelete({{ $item->id }}, '{{ $item->nama_kriteria }}')"
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Mulai dengan menambahkan kriteria penilaian pertama.</p>
                                <div class="mt-6">
                                    <button type="button" data-modal-target="modal-tambah-kriteria" data-modal-toggle="modal-tambah-kriteria"
    ...
    <div id="modal-tambah-kriteria" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden bg-gray-900/50">
    ...
    {{-- Modal Edit Kriteria --}}
    <div id="modal-edit-kriteria" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-xl shadow-2xl">
                {{-- Modal Header --}}
                <div class="flex items-center justify-between p-5 border-b border-gray-200 rounded-t">
    ...
    <div id="modal-hapus-kriteria" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 items-center justify-center overflow-y-auto overflow-x-hidden">
